...
Based on these results, we'll keep movement rate, not daily distance. In addition, we'll exclude variance, because that metric was also correlated with movement rate. Lastly, we'll use log-transformed displacement instead of non-transformed. Now we can move forward and fit our full models.  
